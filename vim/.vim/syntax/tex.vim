...
syn match texTypeStyle		"\\xref"
syn match texTypeStyle		"\\cttx"
syn match texTypeStyle		"\\cttxp"
syn match texTypeStyle		"\\ctnm"
syn match texTypeStyle		"\\ctnmp"
...
syn match  texRefZone		'\\ct\(nms\|nm\|tx\|txp\)\%([tp]\*\=\)\=' nextgroup=texRefOption,texCite
syn match  texRefZone		'\\xref\%([tp]\*\=\)\=' nextgroup=texRefOption,texCite
syn match  texRefZone		'\\nosp\%([tp]\*\=\)\=' nextgroup=texRefOption,texCite
