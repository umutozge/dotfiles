...
silent only
cd ~/Dropbox/res/github/theoretical-linguistics/notes
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 cogs532-lecture-notes.tex
badd +93 03_cogs501-morphology.tex
badd +1 ~/Dropbox/res/github/symbols-and-programming/notes/cogs502-lecture-notes.tex
badd +84 ~/Dropbox/res/github/symbols-and-programming/assignments/cogs502-assignment-01.tex
badd +36 ~/Dropbox/res/github/symbols-and-programming/assignments/cogs502-assignment-02.tex
badd +16 ~/Dropbox/res/github/symbols-and-programming/notes/test.lisp
badd +24 ~/Dropbox/res/github/symbols-and-programming/README.md
badd +21 ~/Dropbox/res/github/symbols-and-programming/notes/dummy.lisp
badd +25 ~/Dropbox/res/github/symbols-and-programming/notes/dummy2.lisp
badd +0 ~/tmp/duygu-ling/Handouts/morph/fle261-morphology.tex
badd +3 ~/Dropbox/lib/dotfiles/.mytex/tex/latex/umut/uenum.sty
argglobal
silent! argdel *
argadd cogs532-lecture-notes.tex
set stal=2
edit cogs532-lecture-notes.tex
...
silent! normal! zE
let s:l = 804 - ((18 * winheight(0) + 17) / 35)
...
tabedit ~/Dropbox/res/github/theoretical-linguistics/notes/03_cogs501-morphology.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/Dropbox/res/github/theoretical-linguistics/notes
tabedit ~/tmp/duygu-ling/Handouts/morph/fle261-morphology.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 322 - ((14 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
322
normal! 0
lcd ~/tmp/duygu-ling/Handouts/morph
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 574 - ((18 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
574
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 641 - ((20 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
641
