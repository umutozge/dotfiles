...
cat_tab = {'backward_linking.csv':['empty','markable'],\
'animacy.csv':["human","animate","inanim_conc_obj","inanim_underspec_obj","abstract"],\
...
def write_table(lot):
	out = open('/home/tumuum/Dropbox/res/prop/dfg/corpus-work/sofar/agreement.tex','w')
