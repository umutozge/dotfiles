...
from_unicode=[u'S',u'S',u'U',u'U',u'G',u'G',u'I',u'I',u'O',u'O',u'C',u'C']
to_unicode=[350,351,220,252,286,287,304,305,214,246,199,231]

acc1=[]

for i in range(len(from_unicode)): 
	acc1 = acc1 + [(ord(from_unicode[i-1]),to_unicode[i-1])]
