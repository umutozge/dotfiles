...
xmlns:nominal="www.eml.org/NameSpaces/nominal"
xmlns:discourse="www.eml.org/NameSpaces/discourse">
...
<xsl:template match="discourse:markable" mode="opening">
...
<xsl:template match="discourse:markable" mode="closing">
<xsl:value-of select="mmax:startBold()"/>
...
<xsl:template match="nominal:markable" mode="opening">
<xsl:value-of select="mmax:startBold()"/>
<xsl:value-of select="mmax:addLeftMarkableHandle(@mmax_level, @id, '[')"/>
<xsl:value-of select="mmax:endBold()"/>
</xsl:template>

<xsl:template match="nominal:markable" mode="closing">
<xsl:value-of select="mmax:startBold()"/>
<xsl:value-of select="mmax:addRightMarkableHandle(@mmax_level, @id, ']')"/>
<xsl:value-of select="mmax:endBold()"/>
</xsl:template>
